...
<div class="master_hobby_plus_body">
		...
		<div class="master_hobby_plus_sub">공지추가</div>
		
		<div class="master_notice_plus_cont">
			<form action="${pageContext.request.contextPath}/master/master_notice_plus_ok.do" method="post" >
			
				<div class="master_notice_plus_cont_sub">
					<label for="n_subject">공지제목</label>
					<textarea class="master_notice_plus_cont_sub_textarea"  placeholder="공지 제목을 적어주세요." id="n_subject" name="n_subject"></textarea>
				</div>
				
				<div class="master_notice_plus_cont_cont">
					<label for="n_cont">공지내용</label>
					<textarea class="master_notice_plus_cont_cont_textarea"  placeholder="공지 내용을 적어주세요." id="n_cont" name="n_cont"></textarea>
				</div>
			
				<div class="master_notice_plus_cont_name">
					<label for="n_admin">공지 작성자</label>
					<input type="text" value="AhAh" name="n_admin" id="n_admin" />
				</div>
