			...
			<form action="${pageContext.request.contextPath}/master/master_qna_update_ok.do" method="post" >
				...
				<div class="master_qna_plus_cont_partA">
					...
					<div class="master_qna_plus_cont_sub">
						...
						<textarea class="master_qna_plus_cont_sub_textarea" id="q_subject" name="q_subject" >${output_qna_update.q_subject}</textarea>
					</div>
					
					<div class="master_qna_plus_cont_cont">
						<label for="q_cont">문의내용</label>
						<textarea class="master_qna_plus_cont_cont_textarea" id="q_cont" name="q_cont" >${output_qna_update.q_cont}</textarea>
					</div>
				
					<div class="master_qna_plus_cont_mid">
						<label for="q_m_id">작성자</label>
						<input type="text" value="${output_qna_update.q_m_id}" name="q_m_id" id="q_m_id" />
					</div>
